...
model *IDModel()
    ...
    M_liq = V*rho_liq # [kg]
    Glucose = 8.104454e-06  #c_glucose0*comp1 # [mol] #Should it be the volume of the filtrate?
    Serine = 0 #c_serine0*comp1 # [mol]
    Biomass = 5.437398e-07 #c_biomass0*comp1 # [mol]
...
# Glucose_mol = (Compounds_in_concentration['Glucose ( g/L)']/180)*0.0001
# Serine_mol = (Compounds_in_concentration['Serine (g/L)']/105.09)*0.0001
# Biomass_cmol = (Compounds_in_concentration['Biomass (g/L)']/24.6)*0.0001
