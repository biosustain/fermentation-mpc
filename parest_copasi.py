...
def parameter_estimation_online(experimental_data1,experimental_data2,
    ...
    try:
        os.rename('/Users/s144510/Documents/fermentationtool/parameter_estimation' + model_for_parest + '.cps',
                  '/Users/s144510/Documents/fermentationtool/parameter_estimation' + model_for_parest + '.xml')
    except OSError:
        pass

    soup = BeautifulSoup(open('/Users/s144510/Documents/fermentationtool/parameter_estimation'
                              + model_for_parest + '.xml', 'r'), 'xml')

    infile = open('/Users/s144510/Documents/fermentationtool/parameter_estimation' + model_for_parest + '.xml', "w")
    ...
    # From xml to cps
    os.rename('/Users/s144510/Documents/fermentationtool/parameter_estimation' + model_for_parest + '.xml',
              '/Users/s144510/Documents/fermentationtool/parameter_estimation' + model_for_parest + '.cps')

    # Run the parameterestimation in Copasi for the model from the terminal
    # Find the path to CopasiSE, it could be the path given below in the comment
    # os.system("/Applications/COPASI/CopasiSE model_mu.cps --save model_mu.cps")
    os.system("/Users/s144510/Documents/fermentationtool/parameter_estimation/CopasiSE " +
    ...
    soup = BeautifulSoup(open('/Users/s144510/Documents/fermentationtool/parameter_estimation' + model_for_parest + '.xml', 'r'), 'xml')
